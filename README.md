...
One quick note: The program Fritzing (https://fritzing.org) was used in this master thesis to create the wiring diagrams and some parts (e. g. the copper pads) are custom made by the author because they didn't exist pre-made in the program. The graphics for the MPR121 have been downloaded from https://github.com/adafruit/Fritzing-Library/.

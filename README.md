...
Regarding the capacitive touch sensing a change was made in comparison to the previous approach which just involves the Arduino, some resistors, cables and of course the copper pads. As seen earlier through some optimizations it was possible to get some decent results but the overall quality still wasn’t as good as hoped. The reliability of the system as well as the signal-to-noise ratio was not ideal. So the search for a better approach continued. The solution that was found was to use the "Adafruit 12-Key Capacitive Touch Sensor Breakout - MPR121". As the name suggests it supports up to 12 individual touch pads. The MPR121 chip handles filtering and can also be configured to be more or less sensible. The following figure shows how this touch sensor gets connected to the Arduino.

<img src="https://user-images.githubusercontent.com/44895720/90894966-aedaf580-e3c1-11ea-9abb-a0dbcb97cd9d.png" height="600">

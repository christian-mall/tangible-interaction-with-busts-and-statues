...
* To power the Arduino, the author decided to plug it into the USB port of a Laptop. Interestingly, when the Laptop itself isn't connected to power, the readings were far more stable.
